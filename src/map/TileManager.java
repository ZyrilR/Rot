...
public class TileManager {
    ...
    public void draw(Graphics2D g) {
        for (int i = 0; i < map.length; i++) {
            System.out.println("MAX SCREEN COL: " + MAX_SCREEN_COL);
            System.out.println("MAX SCREEN ROW: " + MAX_SCREEN_ROW);
            System.out.println("MAP.LENGTH ROW: " + map.length);
            System.out.println("MAP.LENGTH[0] COL: " + map[0].length);
